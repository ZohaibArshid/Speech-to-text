...
parser.add_argument(
    ...
    type=str, 
    required=False, 
    default='openai/whisper-large-v2', #openai/whisper-large-v2
...
parser.add_argument(
    ...
    nargs='+', 
    required=True, 
    default=['custom_data\sample_data\data-00000-of-00015.arrow','custom_data\sample_data\data-00001-of-00015.arrow','custom_data\sample_data\data-00002-of-00015.arrow','custom_data\sample_data\data-00003-of-00015.arrow','custom_data\sample_data\data-00004-of-00015.arrow','custom_data\sample_data\data-00005-of-00015.arrow','custom_data\sample_data\data-00006-of-00015.arrow','custom_data\sample_data\data-00007-of-00015.arrow','custom_data\sample_data\data-00008-of-00015.arrow','custom_data\sample_data\data-00009-of-00015.arrow','custom_data\sample_data\data-00010-of-00015.arrow','custom_data\sample_data\data-00011-of-00015.arrow'], 
...
parser.add_argument(
    ...
    nargs='+', 
    required=True, 
    default=['custom_data\sample_data\data-00012-of-00015.arrow','custom_data\sample_data\data-00013-of-00015.arrow','custom_data\sample_data\data-00014-of-00015.arrow'], 
...
custom_cache_dir = Path(r"D:\Forbmax User Data\waqar sahi\SpeechToText\whisper-finetune-master\train")
feature_extractor = WhisperFeatureExtractor.from_pretrained(args.model_name, cache_dir=custom_cache_dir)
tokenizer = WhisperTokenizer.from_pretrained(args.model_name, language=args.language, task="transcribe", cache_dir=custom_cache_dir)
processor = WhisperProcessor.from_pretrained(args.model_name, language=args.language, task="transcribe", cache_dir=custom_cache_dir)
model = WhisperForConditionalGeneration.from_pretrained(args.model_name, cache_dir=custom_cache_dir)
...
# raw_dataset = load_from_disk(args.train_datasets)

# # Now you can perform any additional processing or filtering as needed
# raw_dataset = raw_dataset.filter(
#     is_in_length_range,
#     input_columns=["input_length", "labels"],
#     num_proc=args.num_proc,
